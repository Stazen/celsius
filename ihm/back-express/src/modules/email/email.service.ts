...
//   const resetPasswordUrl = `${config.clientUrl}/auth/reinitialiser-motdepasse?token=${token}`;
//   const text = `Hi,
...
//   <p>To reset your password, click on this link: <a href="${resetPasswordUrl}" target="_blank">${resetPasswordUrl}</a></p>
...
//   const verificationEmailUrl = `${config.clientUrl}/auth/verifier-email?token=${token}`;
//   const text = `Hi ${name},
...
//   <p>You are almost there. Complete the final step by verifying your email at: <a target="_blank" href=${verificationEmailUrl}>${verificationEmailUrl}</a></p>
