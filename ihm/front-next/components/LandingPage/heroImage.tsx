...
//import CelsiusDashboard from "@/public/images/dashboard_screen.png";
import LightDashboard from "@/public/images/landingPage/lightDahsboard.png";
import DarkDashboard from "@/public/images/landingPage/darkDahsboard.png";
...
export const HeroImage = () => {
    ...
    return (
        <div ref={ref} className="mt-[12.8rem] [perspective:2000px]">
            <div className={classNames("relative bg-hero-gradient bg-white bg-opacity-[0.01] rounded-md border border-white-a08",
                    ...
                    {lines.map((line) => (
                        <span
                            ...
                            className={classNames(
                                "absolute top-0 block h-[1px] w-[10rem] dark:bg-glow-lines bg-glow-lines-blue",
                ...
                <svg
                    className={classNames(
                        ...
                        "dark:[&_path]:stroke-white [&_path]:stroke-black [&_path]:[strokeOpacity:0.2] [&_path]:[stroke-dasharray:1] [&_path]:[stroke-dashoffset:1]",
                ...
                <img className={classNames("relative z-10 transition-opacity delay-[680ms] rounded-md w-full h-full object-cover",
                    inView ? "opacity-100" : "opacity-0"
                )} src={resolvedTheme === "dark" ? DarkDashboard.src : LightDashboard.src } alt="celsius" />
            </div>
        </div>
    );
}   